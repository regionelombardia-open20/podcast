...
?>
<div class="podcast-search element-to-toggle" data-toggle-element="form-search">
...
<!-- podcast_category_id -->
<div class="col-md-4"> <?= 
$form->field($model, 'podcast_category_id')->textInput(['placeholder' => 'ricerca per podcast category id' ]) ?>
