...
class WidgetIconPodcastCategory extends WidgetIcon
{
    ...
    public function init()
    {
        ...
        $this->setLabel(Module::tHtml('amospodcast', 'Categories'));
        $this->setDescription(Module::t('amospodcast', 'Categories'));
        ...
        $this->setUrl(['/podcast/podcast-category/index']);
