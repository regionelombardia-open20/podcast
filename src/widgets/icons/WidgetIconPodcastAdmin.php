...
class WidgetIconPodcastAdmin extends WidgetIcon
{
    ...
    public function init()
    {
        ...
        $this->setLabel(Module::tHtml('amospodcast', 'Admin'));
        $this->setDescription(Module::t('amospodcast', 'Admin'));
        ...
        $this->setUrl(['/podcast/podcast/admin']);
