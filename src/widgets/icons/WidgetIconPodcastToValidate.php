...
class WidgetIconPodcastToValidate extends WidgetIcon
{
    ...
    public function init()
    {
        ...
        $this->setLabel(Module::tHtml('amospodcast', 'To validate'));
        $this->setDescription(Module::t('amospodcast', 'To validate'));
        ...
        $this->setUrl(['/podcast/podcast/to-validate']);
