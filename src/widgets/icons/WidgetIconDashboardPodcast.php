...
class WidgetIconDashboardPodcast extends WidgetIcon
{
    ...
    public function init()
    {
        ...
        $this->setLabel(Module::tHtml('amospodcast', 'Podcast'));
        $this->setDescription(Module::t('amospodcast', 'Podcast'));
        ...
        $this->setUrl(['/podcast/podcast/index']);
